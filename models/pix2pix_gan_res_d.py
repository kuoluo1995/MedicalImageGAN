...
class Pix2PixGANRESD(BaseGanModel):
    ...
    def build_model(self):
        ...
        fake_logit_b = self.discriminator(fake_b, name='discriminator_b')
        ...
        fake_b = tf.clip_by_value(fake_b, -1, 1)
        # fake_ab = tf.concat([self.real_a, fake_b], 3)
        fake_logit_b = self.discriminator(fake_b, reuse=True, name='discriminator_b')
        ...
        self.d_loss_b = d_loss_real_b + d_loss_fake_b+l1_loss(self.fake_res_sample, self.res)
