...
def build_model(batch_input, out_channels, filter_channels=64, reuse=False, name='patch_gan', is_training=False,
                **kwargs):
    with tf.variable_scope(name):
        ...
        h4 = leaky_relu(instance_norm2d(discrim_conv2d(h3, filter_channels * 8, stride=1, name='d_conv_h4'), 'd_in4'))
        h5 = discrim_conv2d(h4, out_channels, stride=1, name='d_conv_h5')
        return h5
