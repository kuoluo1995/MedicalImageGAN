...
class Pix2PixGANEDGE(BaseGanModel):
    ...
    def build_model(self):
        ...
        self.g_loss = self.loss_fn(fake_logit_b, tf.ones_like(fake_logit_b)) + \
                      self.i_lambda * l1_loss(self.fake_b, self.real_b) + \
        ...
        self.d_loss_b = d_loss_real_b + d_loss_fake_b + self.e_lambda * l1_loss(fake_b_edges, real_b_edges)
    ...
    def train(self):
        ...
        for epoch in range(self.pre_epoch, self.total_epoch):
            ...
            for step in range(train_size):
                ...
                fake_b, _, g_loss = self.sess.run([self.fake_b, g_optimizer, self.g_loss],
