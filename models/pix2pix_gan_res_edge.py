...
class Pix2PixGANRESEdge(BaseGanModel):
    ...
    def build_model(self):
        ...
        self.g_loss = self.loss_fn(fake_logit_b, tf.ones_like(fake_logit_b)) + self.i_lambda * l1_loss(self.fake_res, self.res) + self.e_lambda * l1_loss(fake_b_edges, real_b_edges)
