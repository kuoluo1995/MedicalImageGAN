...
class Pix2Pix(BaseGanModel):
    ...
    def build_model(self):
        ...
        self.g_loss_a2b = l1_loss(self._fake_b, self.real_b)
    ...
    def summary(self):
        ...
        self.scalar_summary = tf.summary.merge([lr_summary, g_loss_summary, eval_metric_summary])
    ...
    def train(self):
        ...
        for epoch in range(self.pre_epoch, self.total_epoch):
            ...
            g_loss_sum = 0  # sum one epoch g_loss and d_loss
            ...
            for step in range(train_size):
                ...
                print('{}/{} Epoch:{:>3d}/{:<3d} Step:{:>4d}/{:<4d} g_loss:{:<5.5f}'
                      .format(self.name, self.tag, epoch, self.total_epoch, step, train_size, g_loss))
            # eval G network
