...
def build_model(image, out_channels, filter_channels=64, reuse=False, name='unet', is_training=False, **kwargs):
    ...
    with tf.variable_scope(name):
        ...
        e1 = instance_norm2d(conv2d(image, filter_channels, stride=1, name='g_conv_e1'))
        ...
        e5 = instance_norm2d(conv2d(leaky_relu(e4), filter_channels * 16, name='g_conv_e5'), 'g_in_e5')
        e6 = instance_norm2d(conv2d(leaky_relu(e5), filter_channels * 32, name='g_conv_e6'), 'g_in_e6')
        e7 = instance_norm2d(conv2d(leaky_relu(e6), filter_channels * 64, name='g_conv_e7'), 'g_in_e7')
        e8 = instance_norm2d(conv2d(leaky_relu(e7), filter_channels * 128, stride=(1, 1), name='g_conv_e8'), 'g_in_e8')
