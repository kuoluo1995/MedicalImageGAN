...
output = '/home/yf/dataset/NF'  # E:/Dataset/Neurofibromatosis /home/yf/dataset/NF
...
def processed_data():
    ...
    for i in range(len(source_dirs_a)):
        ...
        if nii_a.shape[2] == nii_b.shape[2] and source_dirs_a[i] == source_dirs_b[i]:
            ...
            path_a = output + '/3d/' + Path(source_dirs_a[i]).stem + '/' + A + '.nii'
            path_b = output + '/3d/' + Path(source_dirs_b[i]).stem + '/' + B + '.nii'
            ...
            dataset_path = output + '/3d/' + Path(source_dirs_a[i]).stem + '.npz'
    ...
    yaml_utils.write(output + '/train_3d_' + A + '2' + B + '.yaml', train_dict)
    ...
    yaml_utils.write(output + '/eval_3d_' + A + '2' + B + '.yaml', eval_dict)
    ...
    yaml_utils.write(output + '/test_3d_' + A + '2' + B + '.yaml', test_dict)

    yaml_utils.write(output + '/error_3d.yaml', error_data_info)
    yaml_utils.write(output + '/dataset_info_3d.yaml', dataset_info)
